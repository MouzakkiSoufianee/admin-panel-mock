...
export default function UpdateResource() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // Handle form submission with resource ID
        console.log({
            resourceId,
            totalResource,
            resourceTitle,
        ...
        // Redirect to resources page after successful update
        router.push('/resources');
    };

    return (
        <div className="p-4 sm:p-6 bg-white min-h-screen">
            <p className="text-h1 text-black mb-6 ml-2">Update resource </p>
                    ...
                    <Card className="rounded-[30px] border border-gray-200">
                        <CardHeader>
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                Edit resources shared with employees across your organization.
                            </p>
                        </CardHeader>
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <Card className='border-[1px]'>
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mb-2">Edit a unique, descriptive name for the resource</p>
                                        <Input
                                            type="text"
